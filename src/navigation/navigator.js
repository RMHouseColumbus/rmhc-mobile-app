...
import Staff from '../components/about/staff.js';
...
const BottomTabBar = createBottomTabNavigator({
  ...
  Map: { screen: createStackNavigator({ Home: Home }, defaultNavConfigs), navigationOptions: () => ({
    tabBarIcon: ({ tintColor }) => (
      <Icon
  ...
  Facilities: { screen: createStackNavigator({ Facilities: Facilities }, defaultNavConfigs), navigationOptions: () => ({
    tabBarIcon: ({ tintColor }) => (
      <Icon
  ...
  Meals: { screen: createStackNavigator({ Meals: Meals }, defaultNavConfigs) , navigationOptions: () => ({
    tabBarIcon: ({ tintColor }) => (
      <Icon
  ...
  Updates: { screen: createStackNavigator({ Updates: Updates }, defaultNavConfigs), navigationOptions: () => ({
    tabBarIcon: ({ tintColor }) => (
      <Icon
